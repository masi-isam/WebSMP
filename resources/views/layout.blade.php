            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link {{ Route::is('siswa.tampil') ? 'active' : '' }}" href="{{ route('siswa.tampil') }}">
                            <div class="sb-nav-link-icon active"><i class="fa-solid fa-users-line"></i></div>
                            Siswa
                        </a>
                        <a class="nav-link {{ Route::is('guru.tampil') ? 'active' : '' }}" href="{{ route('guru.tampil') }}">
